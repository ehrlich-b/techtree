...
// worker/tick × $400 — windows, absorbs glass-co surplus. All bidPrices
// stay below NPC max bid (fair × 0.95 × 2.0) so NPCs win when they need
// the item for construction/maintenance.
const STAPLES = [
